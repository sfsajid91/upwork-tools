...
## Corpus Check
- 223 files · ~438,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4177 nodes · 9688 edges · 178 communities (167 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 119 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92a8c116`
...
## Communities (178 total, 11 thin omitted)

### Community 0 - "live-browser.js"
Cohesion: 0.03
Nodes (125): acceptedDomAlreadyClean(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+117 more)
...
Cohesion: 0.06
Nodes (67): appendAutonomyCounterDirective(), appendBuildPathDirective(), appendDetectorFallback(), appendImageGenDirective(), appendImageToolsDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), automaticHookMode() (+59 more)

### Community 3 - "resumeSession"
Cohesion: 0.06
Nodes (81): applyParamDefaults(), applyParamValue(), applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), buildParamsPanel(), buildPickedAnchorSnapshot(), captureAndEmit(), checkpointPayload() (+73 more)
...
Cohesion: 0.08
Nodes (47): collectUnusedSelectors(), FORBIDDEN, verifyAcceptedFile(), verifyAcceptedSource(), appendCssToSvelteStyle(), appendSanitizedCssRule(), bakeParamValuesInCss(), buildInsertVariantStub() (+39 more)
...
Cohesion: 0.10
Nodes (42): applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns(), rel(), renderText(), safeRead() (+34 more)
...
Cohesion: 0.11
Nodes (35): advanceTabGeneration(), currentTabJobId(), enqueueTabMutation(), getTabState(), isJobDetailsPage(), isValidCaptureMetadata(), metadataKey(), readJobHistory() (+27 more)
...
### Community 42 - "staleness-deep.mjs"
Cohesion: 0.17
...
### Community 63 - "discoverTargetCandidates"
Cohesion: 0.19
...
Cohesion: 0.10
Nodes (30): applyOriginalAttrsToSvelteAnchor(), clearMountErrorCard(), commitAcceptedSvelteComponentToDom(), componentModuleCandidates(), describeMountFailure(), detectDevServerBase(), elementMatchesOriginalMarkup(), findLiveElementForOriginalMarkup() (+22 more)
...
### Community 96 - "readProjectPatternGroups"
Cohesion: 0.27
...
### Community 99 - "context-signals.mjs"
Cohesion: 0.10
...
### Community 103 - "portfolio-match.ts"
Cohesion: 0.23
...
### Community 149 - "applyDeferredSvelteComponentAccepts"
Cohesion: 0.32
...
### Community 156 - "checkElementGptBorderShadowDOM"
Cohesion: 0.38
...
### Community 174 - "scaffoldSvelteComponentSession"
Cohesion: 0.29
Nodes (7): buildPropsScriptV2(), loadSvelteCompiler(), buildVariantStubV2(), compileCheckVariants(), ensureRuntimeHelper(), safeReadSource(), scaffoldSvelteComponentSession()

### Community 175 - "normalizeGitHubEvent"
Cohesion: 0.47
Nodes (6): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs()

### Community 176 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
Nodes (4): checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), elementGradientValue(), spotlightLabel()

## Knowledge Gaps
- **855 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+850 more)
...
- **Why does `loadContext()` connect `context.mjs` to `context-signals.mjs`, `live-server.mjs`, `hook-lib.mjs`, `doctor.mjs`, `hook-before-edit.mjs`?**
