...
## Summary
- 4166 nodes · 9674 edges · 174 communities (167 shown, 7 thin omitted)
...
## Communities (174 total, 7 thin omitted)
...
Cohesion: 0.07
Nodes (46): appendAutonomyCounterDirective(), appendBuildPathDirective(), appendDetectorFallback(), appendImageGenDirective(), appendImageToolsDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), automaticHookMode() (+38 more)
...
Cohesion: 0.05
Nodes (64): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPath(), canonicalPathCache (+56 more)
...
Cohesion: 0.08
Nodes (48): persistJobInsights(), ALL_STORES, appendJobSnapshotIfChanged(), clearAllLocalData(), clearHistory(), clearStores(), configureDatabaseSchema(), createStore() (+40 more)
...
Cohesion: 0.11
Nodes (22): runTextContentAnalyzers(), collectStaticCssText(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette(), checkElementGlow(), checkPageQualityDOM() (+14 more)
...
Cohesion: 0.11
Nodes (32): advanceTabGeneration(), currentTabJobId(), enqueueTabMutation(), getTabState(), isJobDetailsPage(), isValidCaptureMetadata(), metadataKey(), readJobHistory() (+24 more)
...
Cohesion: 0.15
Nodes (22): getLegacyLiveSessionsDir(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo(), applyEvent(), baseSnapshot(), COMPLETED_PHASES (+14 more)
...
### Community 101 - "JobInsights"
Cohesion: 0.07
Nodes (15): JobInsights, ClientPayProfileInput, PageEvent, QualificationDetail, JobRecord, LatestJobCaptureRecord, WatchlistRecord, FakeDatabase (+7 more)
...
### Community 149 - "discoverTargetCandidates"
Cohesion: 0.18
Nodes (16): directChildDirs(), discoverRootsForPattern(), discoverTargetCandidates(), expandSimplePattern(), findTargetExample(), hasFallbackWorkspaceChildren(), isIgnoredWorkspaceDiscoveryDir(), isMonorepoRoot() (+8 more)
...
### Community 159 - "normalizeWorkspacePattern"
Cohesion: 0.24
Nodes (12): escapeRegExp(), extractSectionValue(), isExcludedByWorkspacePattern(), isSelectableCandidate(), nearestPackageRootBetween(), nearestProjectLikeRoot(), normalizeWorkspacePattern(), projectRootFromDoubleStarPattern() (+4 more)
...
## Knowledge Gaps
- **844 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+839 more)
...
- **Why does `loadContext()` connect `context-signals.mjs` to `context.mjs`, `live-server.mjs`, `hook-lib.mjs`, `resolveProject`, `surface-briefs.mjs`, `staleness.mjs`, `doctor.mjs`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `enterLiveRoot()` connect `roots.mjs` to `live-wrap.mjs`, `live-status.mjs`, `live-server.mjs`, `live-accept.mjs`, `live-inject.mjs`, `session-store.mjs`, `live-poll.mjs`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `parseDesignMd()` connect `design-parser.mjs` to `staleness.mjs`, `live-server.mjs`, `doctor.mjs`?**
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.03123809523809524 - nodes in this community are weakly interconnected._
